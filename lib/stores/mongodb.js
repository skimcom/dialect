...
module.exports = function (options) {
  ...
  if (options.db && options.db.collectionNames) {
    Object.defineProperty(STORE, 'db', {value: options.db});
  } else {
    ...
    STORE.collection.findOne(doc, function (err, data) {
      if (err) {
        ...
        if (!data) {
          ...
          callback(new Error('This translation already exists'), null);
        }
